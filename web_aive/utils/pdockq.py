...
class PDockQUtils():
    ...
    def calc_pdockq(self, chain_coords, chain_plddt, t):
    ...
    # #Read chains
    # pdbPath = 'F:/projectFiles/AIVE/result/68_MUT_MT/ranked_0.pdb'
